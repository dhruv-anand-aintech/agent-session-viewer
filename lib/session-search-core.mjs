/**
 * Shared fuzzy search helpers for sidebar (multi-session) and thread (single-session) search.
 * Semantic search hook: replace runSidebarSessionSearch / runThreadSearch with an embedding-backed implementation later.
 */
