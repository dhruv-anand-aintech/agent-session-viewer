...
import { readExtendedAgentSessions } from "./extended-agent-readers.mjs"
  ...
  switch (platform) {
    ...
    case "codex":
      return existsSync(readers.CODEX_SESSIONS_ROOT)
        ? readers.readCodexSessionsCheap()
        : []
    ...
    case "extended-agents":
      return readExtendedAgentSessions("all")
